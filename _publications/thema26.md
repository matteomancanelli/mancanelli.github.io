---
layout: default
title: 'An Incremental Method for Synthesizing Action Theory Abstractions'
authors: <span class="nobr">Bita Banihashemi</span>, <span class="nobr">Yves Lesp&eacute;rance</span>, <span class="nobr">Matteo Mancanelli</span>
publication: To appear in Workshop on Theory and Methods for Abstraction (THEMA 2026), co-located with KR 2026 and FLoC 2026, Lisbon, Portugal.
month: 
month_num: 7
year: 2026
type: conference
paper: THEMA_2026_Incremental_Method_for_Synthesizing_BAT_Abstractions.pdf
doi: 
preprint: 
poster: 
code: 
...
bibtex: "@inproceedings{banihashemi2026incremental,<br/>
  &emsp;title = {An Incremental Method for Synthesizing Action Theory Abstractions},<br/>
  &emsp;author = {Banihashemi, Bita and Lesp{\\'e}rance, Yves and Mancanelli, Matteo},<br/>
  &emsp;booktitle = {Proceedings of the Workshop on Theory and Methods for Abstraction (THEMA 2026)},<br/>
  &emsp;year = {2026}<br/>
}"
ack: 
---
